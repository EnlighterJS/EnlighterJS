...
$languageExamples = array(
    'C', 'Cpp', 'CSharp', 'CSS', 'LESS', 'Diff', 'HTML', 'Java', 'Javascript', 'JSON', 'MarkDown', 'NSIS', 'PHP', 'Python', 'Ruby', 'SQL', 'Unit', 'XML', 'RAW', 'NoHighlight', 'AVRASM', 'Ini', 'Rust', 'Shell', 'VHDL', 'Matlab', 'Generic'
);
